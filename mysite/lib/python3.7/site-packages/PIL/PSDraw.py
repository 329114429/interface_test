...
# 1999-01-10 fl   Added gsave/grestore to images method
# 2005-05-04 fl   Fixed floating point issue in images (from Eric Etheridge)
#
...
class PSDraw:
    ...
    def image(self, box, im, dpi=None):
        """Draw a PIL images, centered in the given box."""
        ...
        if (x, y) != im.size:
            # EpsImagePlugin._save prints the images at (0,0,xsize,ysize)
            sx = x / im.size[0]
            sy = y / im.size[1]
