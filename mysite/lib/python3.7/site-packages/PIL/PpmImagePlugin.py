...
class PpmImageFile(ImageFile.ImageFile):
    ...
    format = "PPM"
    format_description = "Pbmplus images"
    ...
    def _open(self):
        ...
        self.custom_mimetype = {
            b"P4": "images/x-portable-bitmap",
            b"P5": "images/x-portable-graymap",
            b"P6": "images/x-portable-pixmap",
        }.get(magic_number)
...
Image.register_mime(PpmImageFile.format, "images/x-portable-anymap")
