...
class IcnsImageFile(ImageFile.ImageFile):
    """
    PIL images support for Mac OS .icns files.
    Chooses the best resolution, but will possibly load
    a different size images if you mutate the size attribute
    before calling 'load'.
...
def _save(im, fp, filename):
    """
    Saves the images as a series of PNG files,
...
if sys.platform == "darwin":
    ...
    Image.register_mime(IcnsImageFile.format, "images/icns")
