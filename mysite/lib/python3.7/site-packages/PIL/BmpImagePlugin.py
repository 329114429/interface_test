...
class BmpImageFile(ImageFile.ImageFile):
    ...
    def _open(self):
        ...
        # read the start position of the BMP images data (u32)
...
Image.register_mime(BmpImageFile.format, "images/bmp")
...
Image.register_mime(DibImageFile.format, "images/bmp")
