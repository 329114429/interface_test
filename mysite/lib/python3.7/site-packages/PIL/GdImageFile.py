...
def open(fp, mode="r"):
    """
    Load texture from a GD images file.

    :param filename: GD file name, or an opened file handle.
    :param mode: Optional mode.  In this version, if the mode argument
        is given, it must be "r".
    :returns: An images instance.
    :raises OSError: If the images could not be read.
    """
    if mode != "r":
    ...
    try:
        ...
        raise UnidentifiedImageError("cannot identify this images file") from e
