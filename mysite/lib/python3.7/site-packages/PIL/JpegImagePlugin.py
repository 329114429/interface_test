...
def APP(self, marker):
    ...
    if marker == 0xFFE0 and s[:4] == b"JFIF":
        ...
        # parse the images resource block
        offset = 14
...
def SOF(self, marker):
    ...
    # images.  JPEG is colour blind, so we use some simple
...
MARKER = {
    ...
    0xFFD8: ("SOI", "Start of images", None),
    0xFFD9: ("EOI", "End of images", None),
...
def _getmp(self):
    ...
    # Next we should try and parse the individual images unique ID list;
...
def _save(im, fp, filename):
    ...
    if subsampling == "4:4:4":
        ...
        if im.format != "JPEG":
            raise ValueError("Cannot use 'keep' when original images is not a JPEG")
    ...
    # if we optimize, libjpeg needs a buffer big enough to hold the whole images
...
Image.register_mime(JpegImageFile.format, "images/jpeg")
