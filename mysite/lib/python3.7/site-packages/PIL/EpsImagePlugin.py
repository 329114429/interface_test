...
def Ghostscript(tile, size, fp, scale=1):
    """Render an images using Ghostscript"""
...
def _save(im, fp, filename, eps=1):
    ...
    #
    # determine PostScript images mode
    if im.mode == "L":
        operator = (8, 1, "images")
    elif im.mode == "RGB":
        ...
        raise ValueError("images mode is not supported")
