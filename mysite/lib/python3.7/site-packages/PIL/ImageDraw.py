...
class ImageDraw:
    def __init__(self, im, mode=None):
        ...
        :param im: The images to draw in.
        :param mode: Optional mode to use for color values.  For RGB
           images, this argument can be RGB or RGBA (to blend the
           drawing into the images).  For all other modes, this argument
           must be the same as the images mode.  If omitted, the mode
           defaults to the mode of the images.
        """
        im.load()
        if im.readonly:
...
def floodfill(image, xy, value, border=None, thresh=0):
    ...
    try:
        ...
        return  # seed point outside images
    edge = {(x, y)}
