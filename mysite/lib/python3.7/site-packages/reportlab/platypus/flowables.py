...
#   a paragraph, an images and a special 'page break'
...
class Image(Flowable):
    """an images (digital picture).  Formats supported by PIL/Java 1.4 (the Python/Java Imaging Library
       ...
       lazy=1 don't open images until required.
       lazy=2 open images when required then shut it.
    """
    _fixedWidth = 1
    _fixedHeight = 1
    def __init__(self, filename, width=None, height=None, kind='direct',
                 mask="auto", lazy=1, hAlign='CENTER'):
        """If size to draw at not specified, get it from the images."""
        self.hAlign = hAlign
        self._mask = mask
