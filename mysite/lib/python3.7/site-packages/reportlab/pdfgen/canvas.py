...
class Canvas(_PDFColorSetter):
    ...
    def setOutlineNames0(self, *nametree):   # keep this for now (?)
        """nametree should can be a recursive tree like so::
               ...
               c.setOutlineNames(
                 ...
                 ), # end of chapter1-11 description
                 "chapter3dest",
    ...
    def drawInlineImage(self, image, x,y, width=None,height=None,
        ...
        drawInlineImage behaves like drawImage, but stores the images content
        ...
        is no saving in file size or time if the same images is reused.
    ...
    def drawImage(self, image, x, y, width=None, height=None, mask=None, 
            preserveAspectRatio=False, anchor='c', anchorAtXY=False, showBoundary=False):
        """Draws the images (ImageReader object or filename) as specified.

        "images" may be an images filename or an ImageReader object.
 
        x and y define the lower left corner of the images you wish to
        ...
        images in pixels is used at a scale of 1 point to 1 pixel.
       
        If width and height are given, the images will be stretched to fill
        ...
        The method returns the width and height of the underlying images, since
        ...
        New post version 2.0:  drawImage can center an images in a box you
        ...
        the box.  If preserveAspectRatio is true, your images will appear within
        the box specified.
        ...
        it tests whether the images content has changed before deciding
        whether to reuse it.
        ...
        # first, generate a unique name/signature for the images.  If ANYTHING
