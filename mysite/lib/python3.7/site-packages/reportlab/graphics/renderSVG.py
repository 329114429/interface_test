...
class SVGCanvas:
    ...
    def drawImage(self, image, x, y, width, height, embed=True):
        ...
        self.currGroup.appendChild(
                transformNode(self.doc,'images',
                    x=x,y=y,width=width,height=height,
                    href="data:images/png;base64,"+buf,
                    )
                )
...
class _SVGRenderer(Renderer):
    ...
    def _get_link_info_dict(self, obj):
        ...
        if url :
            ...
            #<object data="..." type="images/svg+xml" width="430" height="150" class="img">
            #
            #Once displayed, Firefox and Safari treat the SVG like a frame, and
            #by default clicking on links acts "in frame" and replaces the images.
