...
This example demonstrates creating an images with numpy
...
bit of learning, but the payoff is extremely fast images
...
def VertGradientColumn(surf, topcolor, bottomcolor):
    ...
    # make the column a 3d images column by adding X
