...
g - get and print types in clipboard. If, images blit to screen.
p - place some text into clipboard
a - print types available in the clipboard
i - put images into the clipboard
"""
import os
...
def usage():
    ...
    print("Press the 'i' key to put an images into the clipboard")
...
while going:
    for e in pg.event.get():
        if e.type == pg.QUIT or (e.type == pg.KEYDOWN and e.key == pg.K_ESCAPE):
            ...
            print("Putting images into the clipboard.")
            scrap.set_mode(pg.SCRAP_CLIPBOARD)
            fp = open(os.path.join(main_dir, "data", "liquid.bmp"), "rb")
            buf = fp.read()
            scrap.put("images/bmp", buf)
            fp.close()
