...
def surfdemo_show(array_img, name):
    ...
    while 1:
        ...
        if e.type == pg.MOUSEBUTTONDOWN:
            ...
            # pg.images.save(screen, name+'.bmp')
            # s = pg.Surface(screen.get_size(), 0, 32)
            # s = s.convert_alpha()
            # s.fill((0,0,0,255))
            # s.blit(screen, (0,0))
            # s.fill((222,0,0,50), (0,0,40,40))
            # pg.images.save_extended(s, name+'.png')
            # pg.images.save(s, name+'.png')
            # pg.images.save(screen, name+'_screen.png')
            # pg.images.save(s, name+'.tga')
...
def main():
    ...
    print("Press the mouse button to advance images.")
    print('Press the "s" key to save the current images.')
