...
one or more images file names as command line arguments.
"""
...
def main(*args):
    ...
    Positional arguments:
      one or more images file names.

    This pg.masks demo will display multiple moving sprites bouncing
    off each other. More than one sprite images can be provided.
    """

    if len(args) == 0:
        raise ValueError("Require at least one images file name: non given")
