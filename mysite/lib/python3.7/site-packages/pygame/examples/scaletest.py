...
Shows an interactive images scaler.
...
def main(imagefile, convert_alpha=False, run_speed_test=False):
    """show an interactive images scaler

    Args:
        imagefile - name of source images (required)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("    imagefile       images filename (required)")
        print("    -t              run speed test")
        print("    -convert_alpha  use convert_alpha() on the images's " "surface\n")
    else:
        main(
            sys.argv[1],
