...
class TransformModuleTest(unittest.TestCase):
    ...
    def test_laplacian(self):
        ...
        # a line at the last row of the images.
            ...
            for y in range(5):
                if x < 5:
                    ...
                    self.assertEqual(test_surface.get_at((x, y)),
                                     (255, 255, 0))
        # Check if the original images stayed the same
...
class TransformDisplayModuleTest(unittest.TestCase):
    ...
    def test_flip(self):
        ...
        # now we test the convert() ed images also works.
        surf.fill((255, 255, 255))
        surf2.fill((255, 255, 255))
    ...
    def test_flip_alpha(self):
        ...
        # now we test the alpha images works.
        surf.fill((255, 255, 255))
        surf2.fill((255, 255, 255))
