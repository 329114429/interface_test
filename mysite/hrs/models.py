...
class Dept(models.Model):
    ...
    name = models.CharField(max_length=32, db_column='dname', verbose_name='部门名称')
    location = models.CharField(max_length=32, db_column='dloc', verbose_name='部门所在地')
...
class Emp(models.Model):
    ...
    name = models.CharField(max_length=32, db_column='ename', verbose_name='员工姓名')
